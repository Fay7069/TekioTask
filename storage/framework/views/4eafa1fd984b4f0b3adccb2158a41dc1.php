...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'TekioTask – Teacher'); ?></title>
...
<div class="app-wrapper">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('teacher.routines.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('teacher.routines*') ? 'active' : ''); ?>">
                Routines
            </a>
            <a href="<?php echo e(route('teacher.students')); ?>"
               class="nav-link <?php echo e(request()->routeIs('teacher.students') ? 'active' : ''); ?>">
                Students
            </a>
            <a href="<?php echo e(route('teacher.badges.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('teacher.badges*') ? 'active' : ''); ?>">
                Badges
            </a>
        </nav>
...
<?php /**PATH C:\laragon\www\TekioTask\resources\views/layouts/teacher.blade.php ENDPATH**/ ?>