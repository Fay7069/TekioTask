...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'TekioTask – Therapist'); ?></title>
...
<div class="app-wrapper">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('therapist.dashboard')); ?>"
               class="nav-link <?php echo e(request()->routeIs('therapist.dashboard') ? 'active' : ''); ?>">
                Dashboard
            </a>
            <a href="<?php echo e(route('therapist.case-notes')); ?>"
               class="nav-link <?php echo e(request()->routeIs('therapist.case-notes') ? 'active' : ''); ?>">
                Case Notes
            </a>
        </nav>
...
<?php /**PATH C:\laragon\www\TekioTask\resources\views/layouts/therapist.blade.php ENDPATH**/ ?>