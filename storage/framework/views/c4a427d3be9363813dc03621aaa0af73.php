...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'TekioTask – Parent'); ?></title>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('parent.dashboard')); ?>"
               class="nav-link <?php echo e(request()->routeIs('parent.dashboard') ? 'active' : ''); ?>">
                Dashboard
            </a>
            <a href="<?php echo e(route('parent.home-task')); ?>"
               class="nav-link <?php echo e(request()->routeIs('parent.home-task') ? 'active' : ''); ?>">
                Record Home Task
            </a>
        </nav>
...
<?php /**PATH C:\laragon\www\TekioTask\resources\views/layouts/parent.blade.php ENDPATH**/ ?>