    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('student.routine')); ?>"
               class="nav-link <?php echo e(request()->routeIs('student.routine') ? 'active' : ''); ?>">
                Active Task
            </a>
            <a href="<?php echo e(route('student.rewards')); ?>"
               class="nav-link <?php echo e(request()->routeIs('student.rewards') ? 'active' : ''); ?>">
                My Rewards
            </a>
        </nav>
...
<?php /**PATH C:\laragon\www\TekioTask\resources\views/layouts/student.blade.php ENDPATH**/ ?>